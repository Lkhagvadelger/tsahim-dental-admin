...
var PrismaSessionStore = /** @class */ (function (_super) {
    ...
    function PrismaSessionStore(prisma, options) {
         ...
         * CUID will be used instead.
         */
        _this.dbRecordIdFunction = function (sid) { var _a, _b, _c; return (_c = (_b = (_a = _this.options).dbRecordIdFunction) === null || _b === void 0 ? void 0 : _b.call(_a, sid)) !== null && _c !== void 0 ? _c : (0, cuid_1.default)(); };
        /**
         * Fetch all sessions
         *
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, Promise.all(sid.map(function (s) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                return [2 /*return*/, this.destroy(s, callback)];
                            }); }); }))];
                    case 3:
                        _a.sent();
                        return [3 /*break*/, 6];
                    case 4: return [4 /*yield*/, this.prisma[this.sessionModelName].delete({ where: { sid: sid } })];
                    case 5:
                        _a.sent();
                        _a.label = 6;
                    ...
                    case 7:
                        e_3 = _a.sent();
                        this.logger.warn("Attempt to destroy non-existent session:".concat(String(sid), " ").concat(String(e_3)));
                        if (callback)
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        try {
                            ...
                            this.logger.error("get(): ".concat(String(e)));
                            if (callback)
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        if (!(now.valueOf() >= session.expiresAt.valueOf())) return [3 /*break*/, 5];
                        this.logger.log("Deleting session with sid: ".concat(session.sid));
                        return [4 /*yield*/, this.prisma[this.sessionModelName].delete({
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        return [3 /*break*/, 6];
                    case 4: return [4 /*yield*/, this.prisma[this.sessionModelName].create({
        ...
        _this.touch = function (sid, session, callback) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 6:
                        e_6 = _b.sent();
                        this.logger.error("touch(): ".concat(String(e_6)));
                        if (callback)
    ...
    PrismaSessionStore.prototype.validateConnection = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, ((_c = (_b = (_a = this.prisma) === null || _a === void 0 ? void 0 : _a.$connect) === null || _b === void 0 ? void 0 : _b.call(_a)) !== null && _c !== void 0 ? _c : Promise.reject(new Error('Could not connect'))).catch(function () {
                            _this.disable();
                            _this.stopInterval();
                            _this.logger.error((0, ts_dedent_1.dedent)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Could not connect to Sessions model in Prisma.\n      Please make sure that prisma is setup correctly and that your migrations are current.\n      For more information check out https://github.com/kleydon/prisma-session-store"], ["Could not connect to Sessions model in Prisma.\n      Please make sure that prisma is setup correctly and that your migrations are current.\n      For more information check out https://github.com/kleydon/prisma-session-store"]))));
                        })];
                    case 1:
                        _d.sent();
